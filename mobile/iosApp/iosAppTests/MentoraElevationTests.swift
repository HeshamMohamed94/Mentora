...
final class MentoraElevationTests: XCTestCase {
    ...
    private static let lightOpacity: [MentoraElevationLevel: Double] = [
        .level0: 0, .level1: 0.06, .level2: 0.08, .level3: 0.10, .level4: 0.12,
    ]
    private static let darkOpacityFactor: Double = 0.7
    ...
    func test_shadowColorsetsResolveToRealLightAndDarkValues() {
        ...
        for level in MentoraElevationLevel.allCases {
            ...
            XCTAssertEqual(lightComponents.a, expectedLightOpacity, accuracy: 0.002, "\(level.rawValue) light alpha")
            ...
            XCTAssertEqual(darkComponents.a, expectedDarkOpacity, accuracy: 0.002, "\(level.rawValue) dark alpha")
