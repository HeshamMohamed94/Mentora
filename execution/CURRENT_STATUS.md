...
**Next immediate action:** Task 3 — Extract locked mobile visual references into
`design-to-code/screens/mobile-*.json`. See `execution/PHASE_4_ANDROID_PLAN.md` § 5, Task T3 for
