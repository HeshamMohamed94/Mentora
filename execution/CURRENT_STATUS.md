...
## T6 SLICE 3c — IMPLEMENTED + REVIEWED, PENDING CI (2026-09-19)
...
**What remains:** commit, push, and the real `ios-ci.yml` run — this slice's actual Swift-compile /
`#Preview`-macro verification (impossible on this Windows host). Two named open risks (D122 point 11)
are for that run to answer, not pre-solved here. Once CI is green, Task T6 (3a + 3b + 3c) is complete
in full and T7 may begin.
