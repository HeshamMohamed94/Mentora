...
| 5 | Core component kit A (atoms) | NOT STARTED |
...
**Next immediate action:** Task 4 — App bootstrap: SDK wiring, session restore, locale/theme
bootstrap, Keystore instrumented test. See `execution/PHASE_4_ANDROID_PLAN.md` § 5, Task T4 for
