...
| T7 | Localization foundation: `Localizable.xcstrings` (en+ar, 279 keys), locale/direction environment, `MentoraStrings`, formatters, Node parity+specifier lint | **IN PROGRESS — slices 1-2 of 4 DONE, CI-GREEN.** See "T7 SLICE 1" and "T7 SLICE 2" sections below. Slices 3-4 not started. |
