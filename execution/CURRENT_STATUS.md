...
| T7 | Localization foundation: `Localizable.xcstrings` (en+ar, 279 keys), locale/direction environment, `MentoraStrings`, formatters, Node parity+specifier lint | **IN PROGRESS — slice 1 of 4 DONE, CI-GREEN.** See "T7 SLICE 1" section below. Slices 2-4 not started. |
