...
**Next immediate action:** Task 9 — Explore (+ Learning Paths segment). See
`execution/PHASE_4_ANDROID_PLAN.md` § 5, Task T9 for exact acceptance criteria. Reuse, do not
rebuild: `SearchField` (Task 5), `ui/error/ApiErrorCopy.kt` (Task 7), `CourseCard`/`CourseArtwork`/
`CategoryChip`/`EmptyState`/`ErrorState`/`LoadingState` (Task 8). Known disclosed limitation to
