...
| 6 | Navigation shell: 5-tab bottom nav, per-tab back stacks, guest mode, auth gate | NOT STARTED |
...
**Next immediate action:** Task 6 — Navigation shell: 5-tab bottom nav, per-tab back stacks, guest
mode, auth gate. See `execution/PHASE_4_ANDROID_PLAN.md` § 5, Task T6 for exact acceptance criteria.
Note `SearchField` already exists (built in Task 5) — reuse it, do not rebuild it in Task 9.
