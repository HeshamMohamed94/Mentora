...
**Phase 1 backend module set is now complete: auth, users, courses, categories, enrollment, progress, quiz, certificates.** Remaining Phase 1 work is instructor/admin aggregation endpoints, the media module, the AI Tutor scaffold, and the backend test/seed/documentation pass.
