...
export const screenRoutes: Readonly<Record<string, ScreenRoute>> = {
  ...
  "mobile-explore": { routeIntent: "Bottom Nav → Explore (tab root, Student); lighter pre-auth entry outside the tab bar (Guest)", referenceType: "exact-showcase", screenNumber: 2 },
  ...
  "mobile-course-details": { routeIntent: "Explore (pushed) or Home recommendations (pushed) or Learning Path Details (pushed) — per ux/NAVIGATION_SPEC.md § 3", referenceType: "exact-showcase", screenNumber: 3 },
  ...
  "mobile-home": { routeIntent: "Bottom Nav → Home (tab root)", referenceType: "exact-showcase", screenNumber: 8 },
  "mobile-my-learning": { routeIntent: "Bottom Nav → My Learning (tab root)", referenceType: "exact-showcase", screenNumber: 9 },
  ...
  "mobile-course-player": { routeIntent: "Explore or My Learning (pushed from either) — per ux/NAVIGATION_SPEC.md § 3", referenceType: "exact-showcase", screenNumber: 10 },
  ...
  "mobile-ai-tutor": { routeIntent: "Bottom Nav → AI Tutor (tab root); also pushed contextually from Course Player", referenceType: "exact-showcase", screenNumber: 15 },
  ...
  "mobile-demo-checkout": { routeIntent: "Course Details (pushed) — per ux/NAVIGATION_SPEC.md § 3", referenceType: "exact-showcase", screenNumber: 18 },
  "mobile-purchase-success": { routeIntent: "Demo Checkout (pushed); browser/system back redirects to My Learning tab, not back into checkout (ux/NAVIGATION_SPEC.md § 3, § 6)", referenceType: "exact-showcase", screenNumber: 19 },
